...
namespace AquaFlaim.User.Support.DependencyInjection
{
    public static class ContainerFactory
    {
        ...
        static ContainerFactory()
        {
            ...
            builder.RegisterModule(new AquaFlaim.Interface.Configuration.InterfaceConfigurationModule());
            builder.RegisterModule(new AquaFlaim.Interface.Forms.InterfaceFormsModule());
